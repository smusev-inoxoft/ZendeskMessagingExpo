...
const emitter = new EventEmitter(
  ZendeskMessagingExpoModule ?? NativeModulesProxy.ZendeskMessagingExpo
);
...
export { ZendeskMessagingExpoViewProps, ChangeEventPayload };
